<?php 
	...
	if(isset($_POST['submit'])){
		...
		if(true){
			...
			$old_records = json_decode(file_get_contents("fhir/ordonnance/messages.json"));
		...
		if(!file_put_contents("fhir/ordonnance/messages.json", json_encode($data_to_save, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE), LOCK_EX)){
